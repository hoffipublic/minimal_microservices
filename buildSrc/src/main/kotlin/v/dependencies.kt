...
object Latest {
    enum class Release(val version: String, val repo: String, val path: String, val group: String, val artifact: String) {
        ...
        braveInstrumentation("5.11.1",        MAVEN, MAVEN2, "io.zipkin.brave",              "brave-instrumentation-parent"),
    ...
    enum class Milestone (val version: String, val repo: String, val path: String, val group: String, val artifact: String) {
        ...
        springCloud("Hoxton.SR3",                   SPRING, MS, "org.springframework.cloud", "spring-cloud-dependencies"),
        springCloudCircuitbreaker("1.0.2.RELEASE",  SPRING, MS, "org.springframework.cloud", "spring-cloud-circuitbreaker-dependencies"),
        springSleuth("2.2.2.RELEASE",               SPRING, MS, "org.springframework.cloud", "spring-cloud-sleuth-dependencies"),
        springCloudContract("2.2.2.RELEASE",        SPRING, MS, "org.springframework.cloud", "spring-cloud-starter-contract-verifier")
    }
    enum class Plugin(val version: String, val repo: String, val path: String, val group: String, val artifact: String) {
        kotlin("1.3.71",                      GRADLEPLUGINS, PLUGIN, "", "org.jetbrains.kotlin.jvm"),
        ...
        artifactory("4.15.1",                 GRADLEPLUGINS, PLUGIN, "", "com.jfrog.artifactory"), //("latest"),
        ...
        jib("2.1.0",                      GRADLEPLUGINS, PLUGIN, "", "com.google.cloud.tools.jib")
    }
